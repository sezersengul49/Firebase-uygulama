...
<div>
    <button className="disabled:opacity-30 cursor-pointer text-white inline-flex items-center px-4 py-2 border-transparent text-sm font-medium rounded-sm bg-indigo-700 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 "  disabled={!email || !password} type='submit'>Kayıt Ol</button>
    </div>
